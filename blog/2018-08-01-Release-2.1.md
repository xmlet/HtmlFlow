...
- A new `render()` method that produces a `String` rather than writing to a `PrintStream`. This uses a `StringBuilder` internally and offers better performance than the previous `write()` approach. {/* truncate */}
