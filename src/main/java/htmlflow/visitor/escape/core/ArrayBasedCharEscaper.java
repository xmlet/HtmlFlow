...
/**
 * An abstract class for escaping characters based on a replacement map. It uses an array to store
 * replacements for characters and provides methods to escape characters and strings.
 *
 * <p>Derived and adapted from Guava's ArrayBasedCharEscaper class: <a
 * href="https://github.com/google/guava/blob/master/guava/src/com/google/common/escape/ArrayBasedCharEscaper.java">guava</a>
 *
...
abstract class ArrayBasedCharEscaper extends CharEscaper {
    ...
    /**
     * The array of character replacements. Each index corresponds to a character, and the value at
     * that index is an array of characters representing the replacement.
     *
     * <p>e.g., if replacements[65] is not null, it means that the character 'A' (ASCII 65) has a
     * replacement defined.
     */
     ...
     *
     * <p>Characters with codes greater than or equal to this value are not replaced.
     */
     ...
     *
     * <p>Characters below this value are considered unsafe and will be escaped.
     */
     ...
     *
     * <p>Characters above this value are considered unsafe and will be escaped.
     */
    ...
    protected ArrayBasedCharEscaper(
        ArrayBasedEscaperMap replacements,
        char safeMin,
        char safeMax
    ) {
    ...
    public final String escape(String code) throws NullPointerException {
        ...
        for (int idx = 0; idx < code.length(); idx++) {
            ...
            if (
                (c < replacementLength && replacements[c] != null) ||
                c < safeMin ||
                c > safeMax
            ) {
    ...
    /**
     * Escapes a character that is not safe and does not have a replacement. This method should be
     * implemented by subclasses to provide specific escaping logic.
     *
