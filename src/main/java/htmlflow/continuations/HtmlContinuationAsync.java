...
/**
 * HtmlContinuation for an asynchronous block (i.e. AwaitConsumer) depending of an asynchronous
 * object model. The next continuation will be invoked on completion of asynchronous object model.
 *
