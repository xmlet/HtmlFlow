...
export default function Search(): ReactNode {
  ...
  return (
    <>
      <button
        type="button"
        className="mx-1 inline-flex h-9 w-52 cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-100 px-2.5 text-sm font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-200 max-[1100px]:w-44 max-[996px]:hidden dark:border-white/10 dark:bg-white/5 dark:text-gray-400 dark:hover:border-white/20 dark:hover:bg-white/[0.08]"
