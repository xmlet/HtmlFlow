...
const features = [
  {
    ...
    description: "Write valid HTML 5.2 with compile-time safety. Catch errors before runtime with full IDE support and type checking.",
  },
  {
  ...
  },
  {
    ...
    description: "Templates are plain Java functions. No new templating language to learn. Use the full Java toolchain for templating.",
  },
  {
    title: "Asynchronous Support",
    description: "Bind to async data models seamlessly. Works with Reactive Streams, CompletableFuture, Kotlin coroutines, and any asynchronous API for progressive rendering.",
  }
];
