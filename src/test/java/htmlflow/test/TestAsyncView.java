...
class TestAsyncView {
    ...
    // Hot reload tests
    @Test
    void given_async_work_when_create_hot_view_and_render_it_twice_on_same_model() throws ExecutionException, InterruptedException {
        ByteArrayOutputStream mem = new ByteArrayOutputStream();
        ...
        HtmlViewAsync<AsyncModel<String, Student>> view = HtmlFlow.builder().caching(false).build().viewAsync(TestAsyncView::testAsyncModel);
        write_and_assert_asyncview("asyncTest.html", mem, view, asyncModel);
        mem.reset();
        write_and_assert_asyncview("asyncTest.html", mem, view, asyncModel);
    }
    ...
    @Test
    void given_async_work_when_create_hot_view_and_render_it_twice_on_other_model() throws ExecutionException, InterruptedException {
        ByteArrayOutputStream mem = new ByteArrayOutputStream();
    ...
    @Test
    void given_async_work_when_create_hot_view_then_returns_thenable_and_prints_correct_html() throws ExecutionException, InterruptedException {
        ByteArrayOutputStream mem = new ByteArrayOutputStream();
    ...
    @Test
    void given_async_work_with_double_delay_when_create_hot_view_then_returns_thenable_and_prints_correct_html() throws ExecutionException,
            InterruptedException {
