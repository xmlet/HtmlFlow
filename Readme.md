...
[![Build Status](https://sonarcloud.io/api/project_badges/measure?project=fmcarvalho-xmlet%3AHtmlFlow&metric=alert_status)](https://sonarcloud.io/dashboard?id=fmcarvalho-xmlet%3AHtmlFlow)
...
[![Coverage Status](https://sonarcloud.io/api/project_badges/measure?project=fmcarvalho-xmlet:HtmlFlow&metric=coverage)](https://sonarcloud.io/component_measures?id=fmcarvalho-xmlet:HtmlFlow&metric=Coverage)
...
or use any other form provided in [Maven Central Repository](https://central.sonatype.com/artifact/com.github.xmlet/htmlflow/5.0.3):

```groovy
implementation 'com.github.xmlet:htmlflow:5.0.3'
```
...
**Kotlin developers should use the [htmlflow-kotlin](https://central.sonatype.com/artifact/com.github.xmlet/htmlflow-kotlin/5.0.3) dependency instead.**:
