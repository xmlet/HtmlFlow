...
public class HtmlContinuationSyncCloseAndIndent extends HtmlContinuationSync {
     ...
     * isClosed is useless here.
     */
    public HtmlContinuationSyncCloseAndIndent(
        HtmlVisitor visitor,
    ...
    protected final void emitHtml(Object model) {
        /**
         * !!!!! This continuation may follow a dynamic or await block that may create a block or inline
         * element. Block elements increment (depth) indentation at the beginning and decrement at the
         * end. On the other hand, inline elements keep indentation (depth) unmodified. We assume most
         * dynamic or await blocks will create block elements. Thus, here we start by decrementing
         * depth. However, this could not be true for some cases, and we will get inconsistent
         * indentation !!!!
         */
    ...
    public HtmlContinuation copy(HtmlVisitor visitor) {
        return new HtmlContinuationSyncCloseAndIndent(
            visitor,
            next != null ? next.copy(visitor) : null
