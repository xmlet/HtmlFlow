...
/**
 * @author Pedro Fialho
 *     <p>Class to be used where is an error while writing to the output
 */
public class HtmlFlowAppendException extends RuntimeException {

    private static final UnaryOperator<String> EXCEPTION_MESSAGE = msg ->
        "There has been an exception in writing the Html" +
